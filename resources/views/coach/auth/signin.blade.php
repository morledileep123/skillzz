...
<html lang="en">
  <head>
    ...
    <title>Sign in - Skillzz Coach- Premium and Open Source dashboard template with responsive and high quality UI.</title>
    <!-- CSS files -->
  ...
  <body  class=" border-top-wide border-primary d-flex flex-column">
    <div class="page page-center">
      <div class="container-tight py-4">
        ...
        <form class="card card-md" action="{{route('coach.login')}}" method="post" autocomplete="off" novalidate>
           @csrf
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Coach login account</h2>
            <div class="mb-3">
        ...
        <div class="text-center text-muted mt-3">
          Don't have account yet? <a href="{{ route('coach.register') }}" tabindex="-1">Sign up</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
