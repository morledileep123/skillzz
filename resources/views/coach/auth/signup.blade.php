  ...
  <body  class=" border-top-wide border-primary d-flex flex-column">
    <div class="page page-center">
      <div class="container-tight py-4">
        ...
        <form class="card" action="{{route('coach.register')}}" method="post" autocomplete="off">
           @csrf
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Create Coach new account</h2>
            <div class="mb-3">
        ...
        <div class="text-center text-muted mt-3">
          Already have account? <a href="{{ route('coach.login') }}" tabindex="-1">Sign in</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
