			...
			<div class="row row-deck row-cards">
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="d-flex align-items-baseline">
								<div class="h1 mb-0 me-2">{{ $allCities}}</div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-lg-3">
					<div class="card">
						<div class="card-body">
							<div class="d-flex align-items-center">
								<div class="subheader">Coaches</div>
							  <!-- <div class="ms-auto lh-1">
										<div class="dropdown">
											<a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
											<div class="dropdown-menu dropdown-menu-end">
							...
							<div class="d-flex align-items-baseline">
								<div class="h1 mb-0 me-2">{{ $allCoaches }}</div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-lg-3">
					<div class="card">
						<div class="card-body">
							<div class="d-flex align-items-center">
								<div class="subheader">Parents</div>
							  <!-- <div class="ms-auto lh-1">
										<div class="dropdown">
											<a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
											<div class="dropdown-menu dropdown-menu-end">
							...
							<div class="d-flex align-items-baseline">
								<div class="h1 mb-0 me-2">{{ $allParents }}</div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-lg-3">
					<div class="card">
						<div class="card-body">
							...
							<div class="d-flex align-items-baseline">
								<div class="h1 mb-0 me-2">{{ $allStudents }}</div>
							</div>
						</div>
					</div>
				</div>
        ...
        <div class="row text-center align-items-center flex-row-reverse">
            ...
            <ul class="list-inline list-inline-dots mb-0">
                ...
                <a href="#" class="link-secondary">
                    <!-- Download SVG icon from http://Skillzz-icons.io/i/heart -->
            ...
            <ul class="list-inline list-inline-dots mb-0">
                <li class="list-inline-item">
                Copyright &copy; 2023
                <a href="#" class="link-secondary">Skillzz</a>.
                All rights reserved.
                </li>
                <li class="list-inline-item">
...
@section('javascript')
  ...
  <script src="{{ asset('dist/js/disableBackButton.js') }}"></script>
    <script>
      // @formatter:off
