                ...
                <div class="card">
                    <div class="row row-0">
                        <div class="col">
                            ...
                            <h2 style="text-align:center;">Admin Profile Details</h2>
                                <p>Admin Age:<b>{{ Auth::user()->age }} years</b><br>
                                 Join date of student :<b>{{ Auth::user()->created_at }}</b><br>
                                 Address :<b>{{ Auth::user()->address }}</b><br>
                                 Phone: <b>{{ Auth::user()->phone }}</b><br>
                                 <h2 style="text-align:left;"><a class="btn mt-1 btn-primary" href="{{ route('admin.profile.edit', Auth::user()->id ) }}">Edit profile</a></h2>
                                </p>
                            </div>
                        </div>
                    </div>
