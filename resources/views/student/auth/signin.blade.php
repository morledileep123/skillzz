  ...
  <body  class=" border-top-wide border-primary d-flex flex-column">
    <div class="page page-center">
      <div class="container-tight py-4">
        ...
        <form class="card card-md" action="{{route('student.login')}}" method="post" autocomplete="off" novalidate>
           @csrf
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Student login account</h2>
            <div class="mb-3">
        ...
        <div class="text-center text-muted mt-3">
          Don't have account yet? <a href="{{ route('student.register') }}" tabindex="-1">Sign up</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
